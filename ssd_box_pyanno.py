...
net.data, net.label = CreatePythonInputLayer(layer_params=input_train_parameters)
...
# net.data, net.label = CreatePythonInputLayer(layer_params=input_test_parameters)
VGGNetBody(net, from_layer='data', fully_conv=True, reduced=True, dilated=True,
    dropout=False)
