...
def AddExtraLayers(net, use_batchnorm=True, lr_mult=1):
    ...
    """
    block_name = "c6"
    out_layer = DeconvConnect(net, block_name, out_layer, "conv2_2", out_channels=128, 
        has_connect=False)
    """
...
train_data = "/media/data/seg_dataset/corrosion/lmdb/box_train_ssd_lmdb"
# The database file for testing data. Created by data/VOC0712/create_data.sh
test_data = "/media/data/seg_dataset/corrosion/lmdb/box_val_ssd_lmdb"
...
train_transform_param = {
        'mirror': True,
        'mean_value': [119,916249, 113,8954083, 85,4776983],
        'resize_param': {
                'prob': 1,
...
model_name = "VGG_corrosion_{}".format(job_name)

# Directory which stores the model .prototxt file.
save_dir = "models/VGGNet/corrosion/{}".format(job_name)
# Directory which stores the snapshot of models.
snapshot_dir = "models/VGGNet/corrosion/{}".format(job_name)
# Directory which stores the job script and log file.
job_dir = "jobs/VGGNet/corrosion/{}".format(job_name)
...
name_size_file = "/media/data/seg_dataset/corrosion/ImageSets/test_name_size.txt"
# The pretrained model. We use the Fully convolutional reduced (atrous) VGGNet.
pretrain_model = "models/VGGNet/VGG_ILSVRC_16_layers_fc_reduced.caffemodel"
# Stores LabelMapItem.
label_map_file = "/media/data/seg_dataset/corrosion/ImageSets/labelmap.prototxt"
...
aspect_ratios = [[0.61, 0.82, 0.88, 0.97, 1.0, 1.59],
                 [0.61, 0.82, 0.88, 0.97, 1.0, 1.59],
                 [0.61, 0.82, 0.88, 0.97, 1.0, 1.59],
                 [0.61, 0.82, 0.88, 0.97, 1.0, 1.59],
                 [0.61, 0.82, 0.88, 0.97, 1.0, 1.59],
                 [0.61, 0.82, 0.88, 0.97, 1.0, 1.59]]
...
# JPEGImages : normMean = [0.4702598  0.44664866 0.33520666]
# JPEGImages : normstdevs = [0.13519718 0.1318305  0.1096018 ]

input_train_parameters = {
    'train': True,
    'seg_ratio': 4,
    'sbdd_dir': "/media/data/seg_dataset/corrosion",
    'split': 'train',
    'mean': [119.916249, 113.8954083, 85.4776983],
    'randomize': True,
    'batch_size': 14,
    'im_shape': [384, 384],
    'seed': 1333,
