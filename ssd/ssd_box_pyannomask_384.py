...
def AddExtraLayers(net, use_batchnorm=True, lr_mult=1):
    ...
    block_name = "c4"
    out_layer = DeconvConnect(net, block_name, out_layer, lateral_layer, out_channels=256, 
        k=6, s=4, p=1 ,has_connect=True)

    block_name = "c5"
    out_layer = DeconvConnect(net, block_name, out_layer, "conv1_1", out_channels=64, 
        k=6, s=4, p=1 ,has_connect=True)
...
mbox_source_layers = ['conv3_3_l_c4', 'fc7_l_c3', 'conv6_2_c2', 'conv7_2_c1', 'conv8_2', 'conv9_2']
# in percent %
min_ratio = 20
max_ratio = 90
